...
**Live demo**: [pcprotocol.dev/api/health](https://pcprotocol.dev/api/health)
...
**Try the demo free**:
```bash
curl -X POST https://pcprotocol.dev/api/code-audit \
...
**Endpoint**: `GET https://pcprotocol.dev/api/arb-windows?capitalSol=1.0&minBps=3`
...
**Endpoint**: `GET https://pcprotocol.dev/api/alpha-signals`
...
**Endpoint**: `GET https://pcprotocol.dev/api/token-scan?minLiq=10000&limit=20`
...
| Real arb quotes | [pcprotocol.dev/api/arb-windows](https://pcprotocol.dev/api/arb-windows) |
