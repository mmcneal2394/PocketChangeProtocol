...
export async function buildOverviewSnapshot() {
  ...
  return {
    ...
    capital: {
      ...
      positiveProfitSeekingScore: Number(realizedProfit?.positiveProfitSeekingScore || 0),
      negativeProfitSeekingScoreAbs: Number(realizedProfit?.negativeProfitSeekingScoreAbs || 0),
      totalProfitSeekingScore: Number(realizedProfit?.totalProfitSeekingScore || 0),
      profitSeekingRatio: Number(realizedProfit?.profitSeekingRatio || 0),
      rewardAsymmetryFactor: Number(realizedProfit?.rewardAsymmetryFactor || 0),
