...
function run() {
    return __awaiter(this, void 0, void 0, function () {
        var client, stream, e_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    console.log("Starting Geyser Test...");
                    client = new yellowstone_grpc_1.default("https://yellowstone-solana-mainnet.core.chainstack.com:443", "95d603f3d634acfbf2ac5a57a32baf97", undefined);
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                ...
                case 2:
                    ...
                    stream.on('error', function (err) { return console.log("Stream err:", err); });
                    stream.write({
                        accounts: {
                        ...
                        if (err)
                            ...
                            console.log("Subscribed globally.");
                    });
                    return [3 /*break*/, 4];
                case 3:
                    e_1 = _a.sent();
                    console.error("Crash:", e_1);
                    return [3 /*break*/, 4];
