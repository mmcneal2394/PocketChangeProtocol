    ...
    <>
      ...
      <aside className={`sidebar-mobile ${isOpen ? "open" : ""}`} style={{
        ...
        <div style={{ marginBottom: "48px", display: "flex", alignItems: "center", gap: "12px", position: "relative" }}>
          ...
          <h1 style={{ fontSize: "1.2rem", fontWeight: 800, letterSpacing: "-0.5px", zIndex: 1, flex: 1 }} className="gradient-text">PocketChange</h1>
          {/* Close button for mobile */}
          <button className="mobile-menu-btn" onClick={onClose} style={{ position: "static" }}>
            <Close />
          </button>
        </div>
